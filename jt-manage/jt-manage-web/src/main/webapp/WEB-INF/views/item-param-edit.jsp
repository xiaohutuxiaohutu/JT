<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<table cellpadding="5" style="margin-left: 30px" id="itemParamEditorTable" class="itemParam">
	<input type="hidden" name="id"/>
     ...
     <tr >
       	<td class="params hide">初始商品规格:</td>
       	<td>
...
<script style="text/javascript">
	$(function(){
		...
		$("#itemParamEditorTable .close").click(function(){
			$(".panel-tool-close").click();
		});
		
		$("#itemParamEditorTable .submit").click(function(){
			var params = [];
			var groups = $("#itemParamEditorTable [name=group]");
			...
			var url = "/item/param/update/"+$("#itemParamEditorTable [name=id]").val();
			$.post(url,{"paramData":JSON.stringify(params),"cid":$("#itemParamEditorTable [name=cid]").val()},function(data){
				if(data.status == 200){
